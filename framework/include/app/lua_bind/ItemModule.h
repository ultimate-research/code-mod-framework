...
namespace app::lua_bind {
    namespace ItemModule {
        ...
        bool is_success_pickup_item(app::BattleObjectModuleAccessor *) asm("_ZN3app8lua_bind39ItemModule__is_success_pickup_item_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
        ...
        bool is_success_auto_pickup_item(app::BattleObjectModuleAccessor *) asm("_ZN3app8lua_bind44ItemModule__is_success_auto_pickup_item_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
        bool is_have_item(app::BattleObjectModuleAccessor *, int) asm("_ZN3app8lua_bind29ItemModule__is_have_item_implEPNS_26BattleObjectModuleAccessorEi") LINKABLE;
        ...
        u64 get_have_item_hold_kind(app::BattleObjectModuleAccessor *, int) asm("_ZN3app8lua_bind40ItemModule__get_have_item_hold_kind_implEPNS_26BattleObjectModuleAccessorEi") LINKABLE;
        ...
        u64 get_pickable_item_trait(app::BattleObjectModuleAccessor *) asm("_ZN3app8lua_bind40ItemModule__get_pickable_item_trait_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
        ...
        u64 warp_item(app::BattleObjectModuleAccessor *, const Vector3f*,int) asm("_ZN3app8lua_bind26ItemModule__warp_item_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector3fEi") LINKABLE;
        u64 warp_attach_item(app::BattleObjectModuleAccessor *, const Vector3f*) asm("_ZN3app8lua_bind33ItemModule__warp_attach_item_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector3fE") LINKABLE;
        ...
        u64 set_have_item_hit_sleep(app::BattleObjectModuleAccessor *, int,bool) asm("_ZN3app8lua_bind40ItemModule__set_have_item_hit_sleep_implEPNS_26BattleObjectModuleAccessorEib") LINKABLE;
        ...
        bool is_attach_item(app::BattleObjectModuleAccessor *, app::ItemKind) asm("_ZN3app8lua_bind31ItemModule__is_attach_item_implEPNS_26BattleObjectModuleAccessorENS_8ItemKindE") LINKABLE;
        u64 get_attach_item_count(app::BattleObjectModuleAccessor *) asm("_ZN3app8lua_bind38ItemModule__get_attach_item_count_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
        ...
        u64 eject_attach_item(app::BattleObjectModuleAccessor *, int,bool,bool,bool) asm("_ZN3app8lua_bind34ItemModule__eject_attach_item_implEPNS_26BattleObjectModuleAccessorEibbb") LINKABLE;
        ...
        u64 drop_attach(app::BattleObjectModuleAccessor *, app::ItemKind,float,float) asm("_ZN3app8lua_bind28ItemModule__drop_attach_implEPNS_26BattleObjectModuleAccessorENS_8ItemKindEff") LINKABLE;
        ...
        u64 scale_attach(app::BattleObjectModuleAccessor *, app::ItemKind,float) asm("_ZN3app8lua_bind29ItemModule__scale_attach_implEPNS_26BattleObjectModuleAccessorENS_8ItemKindEf") LINKABLE;
        ...
        u64 set_have_item_team(app::BattleObjectModuleAccessor *, int,int) asm("_ZN3app8lua_bind35ItemModule__set_have_item_team_implEPNS_26BattleObjectModuleAccessorEii") LINKABLE;
