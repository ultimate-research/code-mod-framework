...
namespace app::lua_bind {
    namespace JostleModule {
        ...
        bool is_sleep(app::BattleObjectModuleAccessor *) asm("_ZN3app8lua_bind27JostleModule__is_sleep_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
        u64 jostle_speed_x(app::BattleObjectModuleAccessor *) asm("_ZN3app8lua_bind33JostleModule__jostle_speed_x_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
        u64 speed_attenuation_rate(app::BattleObjectModuleAccessor *) asm("_ZN3app8lua_bind41JostleModule__speed_attenuation_rate_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
        ...
        u64 pos_z(app::BattleObjectModuleAccessor *) asm("_ZN3app8lua_bind24JostleModule__pos_z_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
        ...
        u64 set_push_speed_x_2(app::BattleObjectModuleAccessor *, float const*,bool) asm("_ZN3app8lua_bind37JostleModule__set_push_speed_x_2_implEPNS_26BattleObjectModuleAccessorEPKfb") LINKABLE;
        ...
        u64 priority(app::BattleObjectModuleAccessor *) asm("_ZN3app8lua_bind27JostleModule__priority_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
        ...
        u64 ignore_owner_id(app::BattleObjectModuleAccessor *) asm("_ZN3app8lua_bind34JostleModule__ignore_owner_id_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
        u64 reset_area(app::BattleObjectModuleAccessor *) asm("_ZN3app8lua_bind29JostleModule__reset_area_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
        ...
        u64 set_ignore_pri(app::BattleObjectModuleAccessor *, int) asm("_ZN3app8lua_bind33JostleModule__set_ignore_pri_implEPNS_26BattleObjectModuleAccessorEi") LINKABLE;
        ...
        u64 area_kind(app::BattleObjectModuleAccessor *) asm("_ZN3app8lua_bind28JostleModule__area_kind_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
