...
namespace app::lua_bind {
    namespace AttackData {
        ...
        u64 store_l2c_table(app::AttackData const*,lib::L2CValue const&) asm("_ZN3app8lua_bind32AttackData__store_l2c_table_implEPKNS_10AttackDataERKN3lib8L2CValueE") LINKABLE;
    }
}
