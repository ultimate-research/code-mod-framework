...
namespace lib {
    bool lua_bind_get_value(uint64_t, int*) asm("_ZN3lib18lua_bind_get_valueIiEEbmRT_");
    ...
    struct L2CValue {
        ...
        operator bool() asm("_ZNK3lib8L2CValuecvbEv");
        void push_variadic(uint64_t, const char*, void*) asm("_ZN3lib8L2CValue13push_variadicEmPKcRNS_7utility8VariadicE");
    };
    ...
    struct L2CAgent {
        ...
        L2CAgent* L2CAgent_constr(u64 lua_state) asm("_ZN3lib8L2CAgentC2EP9lua_State");
        u64 push_lua_stack(L2CValue* l2c_value) asm("_ZN3lib8L2CAgent14push_lua_stackERKNS_8L2CValueE");
        // pop_lua_stack
        // Notes: 
        ...
        uint64_t pop_lua_stack(int index) asm("_ZN3lib8L2CAgent13pop_lua_stackEi");
        void get_lua_stack(int index, lib::L2CValue* l2c_val);

        uint64_t sv_set_function_hash(uint64_t (*func)(L2CAgent*, void*), uint64_t hash) asm("_ZN3lib8L2CAgent20sv_set_function_hashEPvN3phx6Hash40E");
        uint64_t clear_lua_stack() asm("_ZN3lib8L2CAgent15clear_lua_stackEv");
        uint64_t _clear_lua_stack();
    };
    namespace utility {
        namespace Variadic {
            const char* get_format(void* variadic) asm("_ZNK3lib7utility8Variadic10get_formatEv");
        }
    }
};
